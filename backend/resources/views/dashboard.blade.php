<x-app-layout>
    ...
    <div class="py-8 bg-[radial-gradient(circle_at_top_left,#ffe8ee_0%,transparent_26%),radial-gradient(circle_at_top_right,#e5f5ef_0%,transparent_24%),linear-gradient(180deg,#fffaf8_0%,#fffdfb_45%,#f6fbfa_100%)]">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="relative mb-8 overflow-hidden rounded-[2rem] border border-[#efd7dc] bg-[linear-gradient(135deg,#fff0f3_0%,#fff9f4_42%,#eef8f5_100%)] p-8 text-slate-900 shadow-[0_24px_70px_rgba(214,176,187,0.22)]">
                ...
                <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                    ...
                    <div class="relative rounded-[1.75rem] border border-white/70 bg-white/75 px-5 py-4 shadow-[0_16px_40px_rgba(181,144,151,0.16)] backdrop-blur">
            ...
            <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                <section class="rounded-[1.75rem] border border-[#f0ddd7] bg-[linear-gradient(180deg,#fffefd_0%,#fff9f7_100%)] p-6 shadow-[0_12px_35px_rgba(219,193,186,0.12)]">
                ...
                <section class="rounded-[1.75rem] border border-[#e2ebe7] bg-[linear-gradient(180deg,#fcfffe_0%,#f4fbf8_100%)] p-6 shadow-[0_12px_35px_rgba(189,212,204,0.16)]">
                ...
                <section class="rounded-[1.75rem] border border-[#eadcf1] bg-[linear-gradient(180deg,#fffefe_0%,#fbf7fd_100%)] p-6 shadow-[0_12px_35px_rgba(213,193,224,0.16)]">
            ...
            <div class="mt-6 grid gap-6 xl:grid-cols-[minmax(0,1.75fr)_minmax(320px,1fr)]">
                <section class="rounded-[1.75rem] border border-[#f0ddd7] bg-[linear-gradient(180deg,#fffefd_0%,#fffaf8_100%)] p-6 shadow-[0_12px_35px_rgba(219,193,186,0.12)]">
                    ...
                    <div class="space-y-3">
                        @forelse ($upcomingAppointments as $appointment)
                            <article class="rounded-[1.4rem] border border-[#f3e4df] bg-[linear-gradient(135deg,#fff8f6_0%,#fffdfc_48%,#f4fbf8_100%)] px-4 py-4 shadow-[0_8px_22px_rgba(232,213,207,0.14)]">
                ...
                <aside class="rounded-[1.75rem] border border-[#f0ddd7] bg-[linear-gradient(180deg,#fffefd_0%,#fffaf7_100%)] p-6 shadow-[0_12px_35px_rgba(219,193,186,0.12)]">
                    ...
                    <div class="mt-5 space-y-3">
                        <a href="{{ route('appointments.index') }}" class="block rounded-[1.4rem] bg-[linear-gradient(135deg,#e8b4ba_0%,#efc5b8_45%,#e8d4bc_100%)] px-4 py-4 text-[#2f2522] shadow-[0_12px_30px_rgba(220,182,180,0.24)] transition hover:translate-y-[-1px] hover:brightness-[0.99]">
                        ...
                        <a href="{{ route('clients.create') }}" class="block rounded-[1.4rem] border border-[#ecd9d3] bg-[#fff6f2] px-4 py-4 transition hover:border-[#dcbfb7] hover:bg-[#fff0ea]">
                        ...
                        <a href="{{ route('services.index') }}" class="block rounded-[1.4rem] border border-[#dbe8e4] bg-[#f2fbf7] px-4 py-4 transition hover:border-[#bfd6cf] hover:bg-[#ebf7f2]">
                        ...
                        <a href="{{ route('workers.index') }}" class="block rounded-[1.4rem] border border-[#ece0ec] bg-[#faf5fb] px-4 py-4 transition hover:border-[#dbc7db] hover:bg-[#f5edf7]">
